...
hl(0, "TabLine", { fg = c.cadet_blue, bg = c.total_black })
hl(0, "TabLineFill", { fg = c.regent_grey })
hl(0, "TabLineSel", { fg = c.mantis, bg = c.total_black })
...
hl(0, "SnacksNotifierInfo", { bg = c.float_bg, fg = c.diag.info })
hl(0, "SnacksNotifierIconInfo", { bg = c.float_bg, fg = c.diag.info })
hl(0, "SnacksNotifierBorderInfo", { bg = c.float_bg, fg = c.diag.info })
hl(0, "SnacksNotifierTitleInfo", { bg = c.float_bg, fg = c.diag.info })

hl(0, "SnacksNotifierWarn", { bg = c.float_bg, fg = c.diag.warning })
hl(0, "SnacksNotifierIconWarn", { bg = c.float_bg, fg = c.diag.warning })
hl(0, "SnacksNotifierBorderWarn", { bg = c.float_bg, fg = c.diag.warning })
hl(0, "SnacksNotifierTitleWarn", { bg = c.float_bg, fg = c.diag.warning })

hl(0, "SnacksNotifierError", { bg = c.float_bg, fg = c.diag.error })
hl(0, "SnacksNotifierIconError", { bg = c.float_bg, fg = c.diag.error })
hl(0, "SnacksNotifierBorderError", { bg = c.float_bg, fg = c.diag.error })
hl(0, "SnacksNotifierTitleError", { bg = c.float_bg, fg = c.diag.error })

hl(0, "SnacksNotifierDebug", { bg = c.float_bg, fg = c.diag.hint })
hl(0, "SnacksNotifierIconDebug", { bg = c.float_bg, fg = c.diag.hint })
hl(0, "SnacksNotifierBorderDebug", { bg = c.float_bg, fg = c.diag.hint })
hl(0, "SnacksNotifierTitleDebug", { bg = c.float_bg, fg = c.diag.hint })

hl(0, "SnacksNotifierTrace", { bg = c.float_bg, fg = c.ship_cove })
hl(0, "SnacksNotifierIconTrace", { bg = c.float_bg, fg = c.ship_cove })
hl(0, "SnacksNotifierBorderTrace", { bg = c.float_bg, fg = c.ship_cove })
hl(0, "SnacksNotifierTitleTrace", { bg = c.float_bg, fg = c.ship_cove })
