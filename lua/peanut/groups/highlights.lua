...
function M.highlight(palette, opts)
    return {
        ...
        SpellBad = { sp = palette.error, underline = true },
        SpellCap = { sp = palette.yellow, underline = true },
        SpellLocal = { sp = palette.sign_add, underline = true },
        SpellRare = { sp = palette.purple, underline = true },
        NormalNC = {
            fg = palette.fg,
            bg = opts.transparent and palette.none or palette.bg,
        },
        ...
        DiffDelete = { fg = palette.sign_delete },
        ...
        WinSeparator = { fg = palette.alt_bg, bg = palette.none },
