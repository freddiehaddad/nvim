...
function M.highlight(palette, opts)
    return {
        ...
        SnacksNotifierWarn = { fg = palette.magenta, bg = palette.bg2 },
        SnacksNotifierDebug = { fg = palette.yellow, bg = palette.bg2 },
        SnacksNotifierError = { fg = palette.red, bg = palette.bg2 },
        SnacksNotifierTrace = { fg = palette.cyan, bg = palette.bg2 },
        ...
        -- SnacksDashboardNormal = { fg = palette.accent },
        ...
        -- SnacksDashboardSpecial = { fg = palette.accent },
